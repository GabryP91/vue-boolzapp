  ...
  data() {
    return {
      ...
      contacts: [
        {
          name: "Utente2",
          avatar: "img-recap/avatar-esempi/avatar2.png",
          index: 0,
          messages: [
            {
            ...
            },
            {
              ...
              message: "Ricordati di comprare anche il pane",
              status: "sent",
              img: "",
            },
            {
            ...
            {
              date: "10/01/2020 15:50:00",
              message: "Fai attenzione anche alla macchina",
              status: "sent",
              img: "",
            },
            {
          ...
          messages: [
            {
              date: "10/01/2020 15:30:55",
              message:
                "Troppa gente, qui dentro, è stata abbattuta come mosche.",
              status: "received",
              img: "",
            },
            {
            ...
            },
            {
              date: "10/01/2020 15:50:00",
              message:
                "Aahhh. Lo sai cosa dice il vecchio Jack Burton in situazioni come questa?",
              status: "received",
              img: "",
            },
            {
            ...
            },
            {
              ...
              message:
                "Jack Burton, qui presente! Il vecchio Jack dice sempre… Basta adesso!",
              status: "received",
              img: "",
            },
          ],
          ...
          messages: [
            {
              date: "10/01/2020 15:30:55",
              message:
                "Davvero volete abbandonare questo film? Ma che razza impossibile!!",
              status: "sent",
              img: "",
            },
            {
        ...
        },
        {
          ...
          messages: [
            ...
            },
            {
              date: "10/01/2020 15:50:00",
              message:
                "Com'è bello il nostro amore, senti come sale,è bello solo se ci sei tuaaa, sotto questa luna dimmi cosa pensi di me.",
              status: "received",
              img: "",
            },
            {
  ...
  methods: {
    connectApi() {
      if (this.contacts[this.activeAvatar].index == 0) {
        ...
        //chiamata tramite libreria axios all'Api che genera immagini random di cani ()
        axios
          .get("https://api.nationalize.io?name=" + this.message)

          .then((risposta) => {
            this.rispMex =
              "Nazionalità: " +
              risposta.data.country[0].country_id +
              " con probabilità dello :" +
              risposta.data.country[0].probability +
              "%";
